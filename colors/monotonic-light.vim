...
hi Normal       ctermbg=white ctermfg=234   cterm=None
hi Visual       ctermbg=white ctermfg=234   cterm=Reverse
...
hi Type         ctermbg=None  ctermfg=233   cterm=Bold
...
hi ColorColumn  ctermbg=254   ctermfg=234   cterm=None
hi Cursor       ctermbg=None  ctermfg=None  cterm=Reverse
hi CursorLine   ctermbg=254   ctermfg=None  cterm=None
hi Directory    ctermbg=white ctermfg=234   cterm=Underline
...
hi PmenuThumb   ctermbg=249   ctermfg=249   cterm=None
hi Search       ctermbg=031   ctermfg=white cterm=None
hi SpecialKey   ctermbg=None  ctermfg=031   cterm=None
hi SpellBad     ctermbg=160   ctermfg=white cterm=None
hi SpellCap     ctermbg=226   ctermfg=234   cterm=None
hi StatusLine   ctermbg=249   ctermfg=234   cterm=Bold
...
hi TabLineSel   ctermbg=white ctermfg=234   cterm=Bold
